 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Thad Owings");
		  toPrint += p1.toString("towings3");
		  
                  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Piyakorn Saetiew");
		  toPrint += p2.toString("psaetiew3");
		  
                  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Andrew Smith");
		  toPrint += p3.toString("asmith379");
                  
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("John Fiorentino");
                  toPrint += p4.toString("jfiorentino3");
                  
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Porter Rivers");
                  toPrint += p5.toString("privers6");
